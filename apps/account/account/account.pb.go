...
type GetProfileResp struct {
	...
	FollowerCount  int64                  `protobuf:"varint,6,opt,name=follower_count,json=followerCount,proto3" json:"follower_count,omitempty"`    // 粉丝数，来自 accounts.follower_count 冗余字段
	FollowingCount int64                  `protobuf:"varint,7,opt,name=following_count,json=followingCount,proto3" json:"following_count,omitempty"` // 关注数，来自 accounts.following_count 冗余字段
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *GetProfileResp) GetFollowerCount() int64 {
	if x != nil {
...
func (x *GetProfileResp) GetFollowingCount() int64 {
	if x != nil {
...
type PublicProfile struct {
	...
	FollowerCount  int64                  `protobuf:"varint,5,opt,name=follower_count,json=followerCount,proto3" json:"follower_count,omitempty"`    // 粉丝数，来自 accounts.follower_count 冗余字段
	FollowingCount int64                  `protobuf:"varint,6,opt,name=following_count,json=followingCount,proto3" json:"following_count,omitempty"` // 关注数，来自 accounts.following_count 冗余字段
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *PublicProfile) GetFollowerCount() int64 {
	if x != nil {
		return x.FollowerCount
	}
	return 0
...
func (x *PublicProfile) GetFollowingCount() int64 {
	if x != nil {
		return x.FollowingCount
	}
	return 0
...
const file_account_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x04R\x06userId\"\xdc\x01\n" +
	...
	"\x0ffollowing_count\x18\a \x01(\x03R\x0efollowingCount\"\xc5\x01\n" +
	...
	"\x0ffollowing_count\x18\x06 \x01(\x03R\x0efollowingCount\"0\n" +
